...
class CSV:
    ...
    def get_transaction(cls, start_date, end_date):
        ...
        if filtered_df.empty:
            ...
            print(filtered_df.to_string(index=False, formatters={"date": lambda x: x.strftime(cls.FORMAT) if pd.notna(x) else 'Invalid date'}))
...
def add():
    CSV.initialize_csv()
    date = get_date("Enter date of transaction (dd-mm-yyyy) or Enter today's date: ", allow_default=True)
    amount = get_amount()
